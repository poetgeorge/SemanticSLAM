...
KITTI原始数据集我已放到百度云
链接：https://pan.baidu.com/s/1xink8C1mjpVoQwzksZs_Pw 
提取码：k1rf

按以下链接制作rosbag数据集
https://gitee.com/taiping.z.git/image2rosbag_KITTIodometry

You can then run the script ``run_C.sh`` to use the system. You have to provide the rostopic ``/camera/image_raw``
